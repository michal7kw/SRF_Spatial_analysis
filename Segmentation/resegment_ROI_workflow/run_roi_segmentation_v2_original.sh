...
export PYTHONPATH="/mnt/e/Githubs/SPATIAL_data/Segmentation/python-packages_v2_original:${PYTHONPATH}"
...
export CONFIG_NAME="${SAMPLE}_original"
export CONFIG_DIR="../Vpt-segmentation" # Assumes JSON is in the Vpt-segmentation folder
export CONFIG_FILE_NAME="${CONFIG_DIR}/cellpose2_custom_2task.json"
